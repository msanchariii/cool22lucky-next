...
export default function Faq() {
    ...
    const faqs = [
        ...
        {
            question: "Can I integrate this HR software third-party applications?",
                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                <p className="mt-6 text-lg text-gray-600 leading-relaxed">
                                    Find quick answers to common questions about our platform, features, pricing, and support. If you need more help, feel free to reach out to our team anytime.
                                </p>
                            </div>
                            ...
                            <div className="space-y-6 pt-8">
                                ...
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-gray-500">Mail Us</p>
                                        <p className="text-lg font-semibold text-gray-900">Contact@hirezy.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
