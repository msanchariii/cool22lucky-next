    ...
    return (
        <section className="p-4">
            <div className="flex flex-col gap-8 py-20">
                <div className="bg-zinc-400 w-full lg:w-4/5 aspect-video mx-auto rounded-3xl flex justify-center items-center text-center">
                    <div className="bg-white/15 cursor-pointer backdrop-blur-md rounded-full p-6 shadow">
